    ...
    <div class="form-group">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-sm-6 col-md-6">
                ...
                <form action="{{url('admin/users/edit/'.Crypt::encrypt($users->id))}}" method="POST"  >
                @csrf
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="custom-select js-example-basic-multiple" id="inputGroupSelect01" name="roles[]" multiple >
                        ...
                        <option style="color: #000;" value="{{$item->id}}" {{$users->hasRole($item->id) ? 'Selected': ''}}>{{$item->name}}..</option>
                        @endforeach
                    </select>
                    @error('roles')
                  ...
                  <div class="form-check">
                    ...
                    <input type="checkbox" class="form-check-input" name="isAdmin"  value="1" {{($users->isAdmin == 1) ? 'checked': ''}}>
