                  ...
                  <tbody>
                      @foreach ($background as $item)
                        <tr>
                          ...
                          <td>
                            @if($item->status == 1)
                            <a href="javascript:void(0)" class="updatesbackgroundstatus" id="backgrounds-{{$item->id }}"
                            ...
                            <td>
                            <a class="btn btn-xs btn-primary" href="{{url('admin/backgrounds/view/'.Crypt::encrypt($item->id))}} ">
                                View
                            </a>
                            
                            <a class="btn btn-xs btn-info" href="{{url('admin/backgrounds/edit/'.Crypt::encrypt($item->id))}} ">
                                Edit
                            </a>
                           
                            
                            <form action="{{url('admin/backgrounds/delete/'.Crypt::encrypt($item->id))}}" method="POST" style="display: inline-block;">
                                @csrf
